...
A lightweight Web UI for PeerSwap, which allows trustless p2p submarine swaps Lightning⇔BTC and Lightning⇔Liquid. Also facilitates BTC⇒Liquid peg-ins and automatic channel fee management. PeerSwap with [Liquid](https://liquid.net) is a great cost efficient way to rebalance lightning channels.
...
Join PeerSwap Discord channel at [PeerSwap.dev](https://peerswap.dev) or, better yet, open an Issue at [PSWeb GitHub](https://github.com/Impa10r/peerswap-web/issues).
